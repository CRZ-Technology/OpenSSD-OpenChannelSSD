...
(
    ...
    always @ (posedge iSystemClock, posedge iReset) begin
        if (iReset) begin
            ...
            rPI_ValidFlag[3:0]      <= (rPI_ValidFlag_b_3[3:0]);
        end
    end
    ...
    assign wtCRxxDone = (rRECSubCounter[4:0] == 5'b00101);
    assign wtRPREDone = (rRECSubCounter[4:0] == 5'b01111);
    assign wRELoopDone = (rRECCounter[17:1] == wTranslatedNum[17:1]);
    assign wtRPSTDone = (rRECSubCounter[4:0] == 5'b11000);
