...
2: BUFR}
  ...
  ipgui::add_param $IPINST -name "NoIDelayCtrl" -widget comboBox
...
proc update_PARAM_VALUE.NoIDelayCtrl { PARAM_VALUE.NoIDelayCtrl } {
	# Procedure called to update NoIDelayCtrl when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NoIDelayCtrl { PARAM_VALUE.NoIDelayCtrl } {
	# Procedure called to validate NoIDelayCtrl
	return true
}
