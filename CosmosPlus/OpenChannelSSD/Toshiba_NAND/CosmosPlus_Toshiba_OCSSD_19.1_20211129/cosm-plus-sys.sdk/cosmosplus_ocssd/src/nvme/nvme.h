...
#define STORAGE_CAPACITY_L				NUMBER_OF_SECTORS_ON_DEVICE//(8*8*2048*256*4) * 4KB = 512GB//not used
...
#define NUMBER_OF_BLOCKS_ON_DEVICE		131072
#define NUMBER_OF_PAGES_ON_DEVICE		33554432
#define NUMBER_OF_SECTORS_ON_DEVICE		134217728
