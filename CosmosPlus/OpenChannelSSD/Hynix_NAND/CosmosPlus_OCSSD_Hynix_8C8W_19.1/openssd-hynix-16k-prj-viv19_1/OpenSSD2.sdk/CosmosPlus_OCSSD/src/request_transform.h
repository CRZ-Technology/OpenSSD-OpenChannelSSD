...
//
// * v1.0.1.oc
//   - Remove data structures of the dependency table related with NAND physical address
...
void ReqTransNvmeToSlice(unsigned int cmdSlotTag, unsigned int startLba, unsigned int nlb,
