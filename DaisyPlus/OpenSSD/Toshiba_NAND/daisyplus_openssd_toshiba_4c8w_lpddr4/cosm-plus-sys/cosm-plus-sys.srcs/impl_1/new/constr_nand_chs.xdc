...
create_clock -period 20.000 -name nand_ch0_virt_clk
create_clock -period 20.000 -name nand_ch0_dqs_as_clk [get_ports nand_if_0_nand_dqs_p]
set_clock_uncertainty 0.2 [get_clocks nand_ch0_dqs_as_clk]
set_clock_latency -source -0.050 [get_clocks nand_ch0_dqs_as_clk]
...
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -max 1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -clock_fall -max -add_delay 1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -min -add_delay -1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -clock_fall -min -add_delay -1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -max 1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -clock_fall -max -add_delay 1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -min -add_delay -1.000 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -clock_fall -min -add_delay -1.000 [get_ports {nand_if_0_nand_dq[*]}]
...
create_clock -period 20.000 -name nand_ch1_virt_clk
create_clock -period 20.000 -name nand_ch1_dqs_as_clk [get_ports nand_if_1_nand_dqs_p]
set_clock_uncertainty 0.3 [get_clocks nand_ch1_dqs_as_clk]
...
create_clock -period 20.000 -name nand_ch2_virt_clk
create_clock -period 20.000 -name nand_ch2_dqs_as_clk [get_ports nand_if_2_nand_dqs_p]
...
create_clock -period 20.000 -name nand_ch3_virt_clk
create_clock -period 20.000 -name nand_ch3_dqs_as_clk [get_ports nand_if_3_nand_dqs_p]
set_clock_uncertainty 0.30 [get_clocks nand_ch3_dqs_as_clk]
...
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -max 0.900 [get_ports {nand_if_3_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -clock_fall -max -add_delay 0.900 [get_ports {nand_if_3_nand_dq[*]}]
