...
#define NSC_1_UCODEADDR XPAR_AXI_BRAM_CTRL_3_S_AXI_BASEADDR
#define NSC_1_BASEADDR	XPAR_T4NFC_HLPER_3_BASEADDR
#else
...
#define NSC_0_UCODEADDR XPAR_AXI_BRAM_CTRL_3_S_AXI_BASEADDR
#define NSC_0_BASEADDR	XPAR_T4NFC_HLPER_3_BASEADDR
#else
...
#define	USER_CHANNELS			1 //(NUMBER_OF_CONNECTED_CHANNEL)		//user configurable factor
