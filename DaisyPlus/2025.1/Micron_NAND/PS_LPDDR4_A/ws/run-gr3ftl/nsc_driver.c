...
{
    {0, 4, 2, 3, 4, 5, 6, 7}, /* MT29F128G08CBCEB -> way configuration : O X X X O X X X */
    {0, 1, 2, 3, 4, 5, 6, 7}  /* MT29F256G08CEECB -> way configuration : O O X X X X X X */
};
...
void __attribute__((optimize("O0"))) V2FResetSync(T4REGS* t4regs, int way)
{
    ...
    if(micron_nand_type != NAND_TYPE_NONE)
    {
